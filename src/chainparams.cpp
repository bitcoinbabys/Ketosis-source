...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("ketosis01.dynu.net", "ketosis01.dynu.net")); // Vultr cloud node 1
        vSeeds.push_back(CDNSSeedData("ketosis02.dynu.net", "ketosis02.dynu.net")); // Vultr cloud node 2
        vSeeds.push_back(CDNSSeedData("ketosis03.dynu.net", "ketosis03.dynu.net")); // Vultr cloud node 3
